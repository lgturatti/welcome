...
- \[DEV\] [Batch inserts vs single-row no PostgreSQL](https://rifeli.dev/blog/2026-05-25-batch-inserts-on-conflict-postgresql/) Reducao de tempo de execução de 47 para 1,4 segundos.
- \[DEV\] [Caminho dourado para ser um desenvolvedor internacional (e ganhando bem!)](https://igor.marcossi.com/caminho-dourado)
- \[DEV\] [Coisas sobre Postgres que eu queria ter aprendido antes](https://challahscript.com/what_i_wish_someone_told_me_about_postgres)
- \[DEV\] [Como a escrita transforma o pensamento matemático](https://www.quantamagazine.org/how-writing-changes-mathematical-thought-20260325/)
...
- \[DEV\] [Docker Image from 1.2GB to under 80MB](https://the-practical-developer.online/posts/docker-image-from-1gb-to-80mb/)
- \[DEV\] [Easy design system setup when there’s no designer](https://www.linkedin.com/pulse/easy-design-system-setup-when-theres-designer-f%C3%A1bio-mendes-ywcde)
- \[DEV\] [Email obfuscation: O que funciona em 2025 para proteger seu endereço?](https://spencermortensen.com/articles/email-obfuscation/)
...
- \[SEC\] [From Traditional Pentesting to PTaaS: What Comes Next?](https://www.linkedin.com/comm/pulse/from-traditional-pentesting-ptaas-what-comes-next-qytne)
- \[SEC\] [Google Dorks - How Hackers Leverage Search Engines for Exploits](https://www.linkedin.com/comm/pulse/google-dorks-how-hackers-leverage-search-engines-exploits-nwlgc)
- \[SEC\] [How can you be sure that Ethical Hackers are TRULY Ethical?](https://www.linkedin.com/comm/pulse/how-can-you-sure-ethical-hackers-truly-the-cyber-security-hub-mep7e)
- \[SEC\] [Log Monitoring & 2025 Compliance: Undeniable Conjunction](https://www.linkedin.com/comm/pulse/log-monitoring-2025-compliance-undeniable-conjunction-gb5me)
- \[SEC\] [Master Your First 90 Days as CISO: A 15-Step Framework for Success](https://www.linkedin.com/comm/pulse/master-your-first-90-days-ciso-15-step-framework-dpt2e)
- \[SEC\] [MITRE Reveals 25 Most Dangerous Software Vulnerabilities](https://www.linkedin.com/comm/pulse/mitre-reveals-25-most-dangerous-software-vulnerabilities-sqb8e)
- \[SEC\] [Portable Hacking Lab - Control The Smallest Kali Linux With a Smartphone](https://www.mobile-hacker.com/2024/10/04/portable-hacking-lab-control-the-smallest-kali-linux-with-a-smartphone/)
- \[SEC\] [Top 6 Malware Persistence Mechanisms Used by Hackers: A Detailed Guide](https://www.linkedin.com/comm/pulse/top-6-malware-persistence-mechanisms-used-hackers-detailed-ey45c)
- \[SEC\] [Why the MITRE ATT&CK Evaluation Is Essential for Security Leaders](https://www.linkedin.com/comm/pulse/why-mitre-attck-evaluation-essential-security-leaders-eqq6c)
...
- [RocketSeat: Configuração de ambiente - C#, Full-Stack, Java, Node.JS, Python e React](https://efficient-sloth-d85.notion.site/Configura-o-de-ambiente-307a6d44d5ed4b76b76847a5ad1505df)
- [RocketSeat: Configuração de ambiente - React Native](https://docs-rocketseat.notion.site/Configura-o-de-ambiente-React-Native-149395da577080fcad5df7ef11473819)
- [RocketSeat: NLW Connect](https://efficient-sloth-d85.notion.site/NLW-Connect-Guia-do-evento-e223fad187bd435c8b751913fc4019eb)
- [RocketSeat: NLW Operator](https://efficient-sloth-d85.notion.site/Trilhas-NLW-Operator-310395da577080d2a479f472761c1b44)
- [RocketSeat: NLW Operator - Trilha iniciante: Aprenda a programar com IA](https://efficient-sloth-d85.notion.site/Trilha-Iniciante-Aprenda-a-programar-com-IA-310395da577080cd9e65f221b1eb5388)
- [RocketSeat: NLW Operator - Trilha FullStack: Workflows agênticos](https://efficient-sloth-d85.notion.site/Trilha-Full-Stack-Workflows-ag-nticos-310395da577080a181dcd509f5bcd359)
- [RocketSeat: NLW Pocket Mobile](https://efficient-sloth-d85.notion.site/NLW-POCKET-Mobile-Guia-do-evento-08846d7bb67b462cad5959836f473474)
- [RocketSeat: NLW Pocket Mobile - Kotlin](https://docs-rocketseat.notion.site/Configura-o-de-ambiente-Kotlin-c923ba2a40984cf9aa5aad7f9db70ccd)
- [RocketSeat: NLW Pocket Mobile - React Native](https://docs-rocketseat.notion.site/Configura-o-de-ambiente-React-Native-149395da577080fcad5df7ef11473819)
- [RocketSeat: NLW Pocket Mobile - Swift](https://docs-rocketseat.notion.site/Configura-o-de-ambiente-Swift-149395da57708058bcc3d3fc6926be82)
- [RocketSeat: PHP na prática](https://efficient-sloth-d85.notion.site/PHP-Na-pr-tica-1a9130cb4e424706a03435bdb36e4205)
- [RocketSeat: START - 1. Lógica de programação](https://drive.google.com/file/d/1GUe56knQrj_nCaXA6yFuIZYYPesAFa3X/view)
- [RocketSeat: START - 2. Hábitos de devs que buscam o próximo nível](https://efficient-sloth-d85.notion.site/7-H-bitos-de-devs-que-buscam-o-pr-ximo-n-vel-17a4ea0ed7874a059227e4f223b37d06)
- [RocketSeat: START - 3. Como aprender e se organizar na programação](https://efficient-sloth-d85.notion.site/Guia-para-Aprender-a-Aprender-e-se-Organizar-na-Programa-o-em-2025-b8913dbe262e4a8780dc01ce93ea3b00)
- [RocketSeat: START - 4. Dicas de organização de estudos](https://drive.google.com/file/d/1nSF9JIcqA70WxpknX5EoqoNtI2Rq8XJz/view)
- [RocketSeat: START - 5. O que saber para se tornar programador](https://drive.google.com/file/d/1QCuEO-NcN5inxQdLsG-SUcOq1h9xpVZv/view)
- [RocketSeat: START - 6. Guia de Design para programadores](https://efficient-sloth-d85.notion.site/Guia-de-Design-para-Programadores-Criando-interfaces-eficientes-e-otimizando-c-digos-ffb0b7100e4a403e827a8391c371e7a1)
- [The Valley of Code by Flavio Copes](https://thevalleyofcode.com)

## GitHub / GitLab Projects
- \[GIT\] [A história do GitHub](https://blog.brachiosoft.com/en/posts/git/)
- \[GIT\] [ARMbian: Linux em processadores ARM](https://github.com/ophub/amlogic-s9xxx-armbian)
- \[GIT\] [Codebase to Easy Tutorial with AI from public GitHub repository URL](https://github.com/The-Pocket/PocketFlow-Tutorial-Codebase-Knowledge)
- \[GIT\] [DocLing: analisa documentos e os exporta para o formato desejado com facilidade e rapidez (Python)](https://github.com/DS4SD/docling)
...
- \[GIT\] [TinyStatus: DevOps monitoring page generated by a Python script](https://github.com/harsxv/tinystatus)
- \[GIT\] [VouCasar - Lista de Casamento](https://github.com/CauaGoms/voucasar) open source
- \[GIT\] [W11: Admin system tweaks com powershell](https://github.com/christitustech/winutil)
- \[GIT\] [W11 tiny11builder - Scripts para criar uma imagem simplificada no PowerShell](https://github.com/ntdevlabs/tiny11builder)
- \[GIT\] [Web-App para gerenciamento de bookmarks](https://github.com/blakewatson/bookmarks)
- \[GIT\] [Web-Editor - codespaces](https://docs.github.com/en/codespaces/developing-in-codespaces/web-based-editor)
...
- [ShadowServer Dashboard](https://dashboard.shadowserver.org/#web-cves)

## Tools
- [Acesso remoto gratuito no navegador - openSource](https://www.dwservice.net)
- [AI: Alpaca - Canvas com tecnologia de IA para artistas digitais](https://www.alpacaml.com)
...
- [Consulta IMEI para ver a situação de um aparelho celular](http://www.anatel.gov.br/celularlegal)
- [Conversor de documentos](https://www.ilovepdf.com)
- [Conversor de imagens](https://www.iloveimg.com)
- [Criador de Flipbook Online com AI](https://fliphtml5.com)
- [CSV SQL Tool: Run queries directly in your browser](https://csvsqltool.com)
- [DEBUG: 67 Weird tricks your browser doesn't want you to know](https://alan.norbauer.com/articles/browser-debugging-tricks)
- [DESIGN Dribbble: Explore o trabalho de designers talentosos para seu próximo projeto](https://dribbble.com)
- [DETRAN: Transferência de documentos online](https://www.transferenciadigital.detran.sp.gov.br)
- [Download da imagem oficial do W11](https://www.microsoft.com/en-us/software-download/windows11)
- [Email obfuscation](https://www.albionresearch.com/tools/obfuscator)
- [Extrair texto de imagem](https://www.imagetotext.info/)
- [Ferramenta pra baixar conteúdos do Instagram](https://snapinsta.app/pt)
- [Ferramentas para manuseio de arquivos PDF](https://www.ilovepdf.com)
- [FrontendMasters: Your path to senior developer and beyond](https://frontendmasters.com) Gratuito
- [Gamepad: app para configurações no Windows - DS4W](https://ds4-windows.com)
- [Gerador de tutorial a partir de um repositório GitHub publico](https://code2tutorial.com)
- [GitHub Student Developer Pack](https://education.github.com/pack) Gratuito
- [GO Playground](https://go.dev/play/) Teste seu código online
- [Google Colab: Permite escrever e executar Python no navegador](https://colab.research.google.com)
- [Google IDX: Ambiente de desenvolvimento online e/com banco de dados](https://idx.google.com)
- [Google Spreadsheets into RESTful APIs](https://www.zerosheets.com)
- [GRUB: tunning/ajustes para deixar sua tela de inicialização incrível](https://www.edivaldobrito.com.br/mudar-o-visual-do-grub-com-o-tema-vimix/)
- [IA: Claude AI](https://claude.ai)
- [IA: Inteligência artificial brasileira](https://www.maritaca.ai)
- [IA: Perplexity: pesquise e descubra com IA](https://www.perplexity.ai)
- [Inglês: Aprenda, estude, corrija textos e muito mais](https://www.grammarly.com)
- [Interview Coder - Assinatura USD](https://www.interviewcoder.co)
- [IP Subnet Calculator](https://www.calculator.net/ip-subnet-calculator.html)
- [Lista com os maiores programas em Shell do mundo](https://github.com/oils-for-unix/oils/wiki/The-Biggest-Shell-Programs-in-the-World) (e respectivos links)
- [Moshi IA: voice chat in English](https://moshi.chat/?queue_id=talktomoshi)
- [Obsidian: Ferramenta para anotação e vínculo de ideias com salvamento em arquivo texto](https://obsidian.md)
- [OCR: Document to Markdown com IA - OCR MUITO preciso](https://llamaocr.com)
- [One: a new React framework for web and native, built on Vite](https://onestack.dev)
- [Pinggy: Public URLs for Localhost, without downloading any binary](https://pinggy.io)
- [Pinterest Downloader](https://pinterestdownloader.com)
- [Pocketbase: Backend Open Source em um arquivo](https://pocketbase.io)
...
- [VSCode Extension: Web Visual Editor - debug made easy](https://marketplace.visualstudio.com/items?itemName=Urin.vscode-web-visual-editor)
- [WebGradients: 180 free linear gradients](https://webgradients.com)
...
## Unsorted links / Atalhos diversos
- [Blog V8 bits](https://v8bits.blogspot.com/)
- [Internet Example website](http://www.example.com)
...
- [Qual macbook comprar](https://qualmacbookcomprar.com.br)

## Videos
- [10 alternativas mais eficientes para o terminal Linux](https://www.youtube.com/watch?v=uE4wiVA4YBw)
- [Análise: Secure boot e Linux](https://m.youtube.com/watch?v=Mum0OLpwuvQ)
- [AutoInstalação do Ubuntu com autoinstall.yaml](https://www.youtube.com/watch?v=pB3Td7paWUc)
- [Calculadora mecânica em divisão por zero](https://youtube.com/shorts/DT0jXI-Z6iw?si=vTKEqgBBdD7TGt2T)
